	...
	<main>
		<div class="row justify-content-center">
			<div class="col-sm-6 col-md-6 col-xl-3 mb-3 pr-0">
				...
				<img class="img-thumbnail mb-3 pr-0" src="gain.png" alt="Gain Wash Bottle" width="960" height="600">

			</div>
			
			<div class="col-sm-6 col-md-6 col-xl-3 mb-3">
				<h5 class="mb-4 pl-2" style="text-align: left;">Gain Wash</h5>
				<h5 class="mb-5 pl-2" id="price" style="text-align: left;">$7.50</h5>
				...
				<div id="accordion">
					<div class="card">
						...
						<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
							<div class="card-body">
								Gain Wash Aroma Boost original is guaranteed to clean your clothes and leave a long lasting freshness to them. Now, 33% larger.
							</div>
						</div>
					</div>
				...
				if (mysqli_num_rows($result) > 0) {
					...
					while( $row = mysqli_fetch_array($result) ); 
					{
						...
						<form method="post" action="cart.php?action=add&id=13">
							...
							<input type="hidden" name="hidden_name" value="Gain Wash" >
							<input type="hidden" name="hidden_price" value="7.50">
