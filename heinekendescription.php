...
<main>
  <div class="row justify-content-center">
    ...
    <div class="col-sm-6 col-md-6 col-xl-3 mb-3">
      <h5 class="mb-4 pl-2" style="text-align: left">Heineken Beer</h5>
      <h5 class="mb-1 pl-2" id="price" style="text-align: left">$4.00</h5>
      <h6 class="mb-5 pl-2" style="text-align: left">$24.00/12-pack</h6>
      ...
      <div id="accordion">
        ...
        >
        <div class="card-body">
          Take on the summer with this dutch brewed beer. Contains 5.3%
          alcohol. (330ml/Bottle)
        </div>
      </div>
    </div>
  </div>
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while( $row = mysqli_fetch_array($result) ); 
    {
      ...
      <form method="post" action="cart.php?action=add&id=22">
      ...
      <input type="hidden" name="hidden_name" value="Heineken Beer" >
      <input type="hidden" name="hidden_price" value="4.00">
