...
<head>
	<meta charset="utf-8">
	<title>Snack Section</title>
	<link rel="icon" href="snackicon.png">
...
<div class="d-flex flex-column flex-md-row align-items-center p-2 px-md-4 bg-white border-bottom box-shadow">
	<h5 class="my-0 mr-md-auto font-weight-normal" style="margin:auto;">Snacks Section</h5>
...
<main>
      ...
      <div class="col-sm-6 col-md-6 col-xl-3 mb-3">
        <a href="snickersdescription.php">
          <img class="img-thumbnail mb-3" src="snickers.jpg" alt="Snickers" width="960" height="600">
          <h6 class="mb-1" style="text-align: center;">Snickers Bar</h6>
        </a>
      </div>
      ...
      <div class="col-sm-6 col-md-6 col-xl-3 mb-3">
        <a href="tvbardescription.php">
          <img class="img-thumbnail mb-3" src="tv_bar.jpg" alt="Pricing screenshot" width="960" height="600">
          <h6 class="mb-1" style="text-align: center;">TV Bar</h6>
        </a>
      </div>
      ...
      <div class="col-sm-6 col-md-6 col-xl-3 mb-3">
        <a href="pringlesdescription.php">
          <img class="img-thumbnail mb-3" src="pringles.jpg" alt="Checkout screenshot" width="960" height="600">
          <h6 class="mb-1" style="text-align: center;">Pringles</h6>
        </a>
      </div>
      ...
      <div class="col-sm-6 col-md-6 col-xl-3 mb-3">
        <a href="maltesersdescription.php">
          <img class="img-thumbnail mb-3" src="maltesers.jpg" alt="Product screenshot" width="960" height="600">
          <h6 class="mb-1" style="text-align: center;">Maltesers</h6>
        </a>
      </div>
    </main>
