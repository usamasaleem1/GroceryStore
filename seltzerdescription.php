...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>Happy Dad Hard Selzter</title>
    <link rel="icon" href="alcohol_icon.png" />
  </head>
  <body>
    <!-- Nav bar -->
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0">
          ...
          <a class="btn btn-outline-primary ml-1" href="signinpage.php"
            >Sign in</a
          >
        </form>
      </div>
    ...
    >
      ...
      <a class="btn btn-outline-primary" href="cart.php"
        >Go To Cart <img src="trolley.png" width="30px" height="30px" />
      </a>
    </div>
    ...
    <main>
      <div class="row justify-content-center">
        <div class="col-sm-6 col-md-6 col-xl-3 mb-3 pr-0">
          <img
            class="img-thumbnail mb-3 pr-0"
            src="seltzer.png"
            alt="Happy Dad Seltzer"
            width="960"
            height="600"
          />
        </div>
        ...
        <div class="col-sm-6 col-md-6 col-xl-3 mb-3">
          <h5 class="mb-4 pl-2" style="text-align: left">
            Happy Dad Hard Seltzer
          </h5>
          <h5 class="mb-1 pl-2" id="price" style="text-align: left">$2.00</h5>
          <h6 class="mb-5 pl-2" style="text-align: left">$20.00/12-pack</h6>
          ...
          <div id="accordion">
            <div class="card">
              ...
              >
                <div class="card-body">
                  Quench your thirst with this delicious hard seltzer which
                  comes in a variety of fruity flavors. Contains 5% alcohol.
                  (355ml/Can)
                </div>
              </div>
            </div>
...
<form>
	<div class="form-group mt-4">
		...
		<input id="cartCount" onchange="updateCartPrice()" type="number" style="width: 100px;" class="form-control" value="1" id="cart" placeholder="Quantity">
	</div>
        ...
        <div class="col-6 col-md">
          ...
          <ul class="list-unstyled text-small">
            ...
            <li>
              <a
                class="text-muted"
                href="https://www.google.com/maps/place/11011+Bd+Maurice-Duplessis,+Montr%C3%A9al,+QC+H1C+1V3/@45.6660703,-73.5345729,17z/data=!3m1!4b1!4m5!3m4!1s0x4cc8e1759aa6762d:0x80db5bbbc6e3d671!8m2!3d45.6660703!4d-73.5323842"
                target="_blank"
                >Location</a
              >
            </li>
