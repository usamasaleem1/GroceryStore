	...
	<main>
		<div class="row justify-content-center">
			<div class="col-sm-6 col-md-6 col-xl-3 mb-3 pr-0">
				...
				<img class="img-thumbnail mb-3 pr-0" src="maltesers.jpg" alt="Snickers Bar" width="960" height="600">
			...
			<div class="col-sm-6 col-md-6 col-xl-3 mb-3">
				<h5 class="mb-4 pl-2" style="text-align: left;">Maltesers™</h5>
				<h5 class="mb-5 pl-2" id="price" style="text-align: left;">$2.50</h5>
				...
				<div id="accordion">
					<div class="card">
						...
						<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
							<div class="card-body">
							With a crunchy, light center and covered in rich milk chocolate, every piece of MALTESERS Malt Ball Candy is one part fun and one part delicious. MALTESERS Candies contain no artificial colors, flavours or preservatives. MALTESERS Candy melts in your mouth and satisfies your playful side. This chocolatey candy comes in compact-sized balls that you'll love to eat piece by piece!						</div>
						</div>
					</div>
				...
				if (mysqli_num_rows($result) > 0) {
					...
					while( $row = mysqli_fetch_array($result) ); 
					{
						...
						<form method="post" action="cart.php?action=add&id=20">
							...
							<input type="hidden" name="hidden_name" value="Maltesers" >
							<input type="hidden" name="hidden_price" value="2.50">
