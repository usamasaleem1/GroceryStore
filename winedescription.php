...
<main>
  <div class="row justify-content-center">
    ...
    <div class="col-sm-6 col-md-6 col-xl-3 mb-3">
      <h5 class="mb-4 pl-2" style="text-align: left">Barefoot Red Wine</h5>
      <h5 class="mb-1 pl-2" id="price" style="text-align: left">$10.00</h5>
      ...
      <div id="accordion">
        ...
        >
        <div class="card-body">
          Relax and antioxidize with some delicious sweet red wine.
          Contains 14.5% alcohol. (750ml/Bottle)
        </div>
      </div>
    </div>
  </div>
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while( $row = mysqli_fetch_array($result) ); 
    {
      ...
      <form method="post" action="cart.php?action=add&id=23">
      ...
      <input type="hidden" name="hidden_name" value="barefoot Red Wine" >
      <input type="hidden" name="hidden_price" value="10.00">
