...
<head>
	...
	<meta charset="utf-8">
	<title>Oxi-Clean Variety Pack</title>
		...
		<main>
			<div class="row justify-content-center">
				<div class="col-sm-6 col-md-6 col-xl-3 mb-3 pr-0">
					...
					<img class="img-thumbnail mb-3 pr-0" src="oxy.png" alt="Oxi Clean Variety Pack Bottles" width="960" height="600">

				</div>

				<div class="col-sm-6 col-md-6 col-xl-3 mb-3">
					<h5 class="mb-4 pl-2" style="text-align: left;">Oxi-Clean Variety Pack</h5>
					<h5 class="mb-5 pl-2" id="price" style="text-align: left;">$15.50</h5>
					...
					<div id="accordion">
						<div class="card">
							...
							<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
								<div class="card-body">
									This Oxi-Clean variety pack includes three different detergents for all your different cleaning needs: Free & Clear, Refreshing Lavender & Lily, and Sparkling Fresh.
								</div>
							</div>
						</div>
					...
					if (mysqli_num_rows($result) > 0) {
						...
						while( $row = mysqli_fetch_array($result) ); 
						{
							...
							<form method="post" action="cart.php?action=add&id=16">
								...
								<input type="hidden" name="hidden_name" value="Oxi-Clean Variety Pack" >
								<input type="hidden" name="hidden_price" value="15.50">
