...
<main>
	<div class="row justify-content-center">
		<div class="col-sm-6 col-md-6 col-xl-3 mb-3 pr-0">
			...
			<img class="img-thumbnail mb-3 pr-0" src="pringles.jpg" alt="Pringles" width="960" height="600">
		...
		<div class="col-sm-6 col-md-6 col-xl-3 mb-3">
			<h5 class="mb-4 pl-2" style="text-align: left;">Pringles™ Chips</h5>
			<h5 class="mb-5 pl-2" id="price" style="text-align: left;">$2.00</h5>
			...
			<div id="accordion">
				<div class="card">
					...
					<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
						<div class="card-body">
							Enjoy the classic flavour of Pringles Original Grab & Go Chips, Original crunchy flavour, Convenient and portable, Re-sealable container to lock in freshness.
						</div>
					</div>
				</div>
