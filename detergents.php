...
<head>
	<meta charset="utf-8">
	<title>Detergents Section</title>
	<link rel="icon" href="detergenticon.png">
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
	...
	<a class="navbar-brand" href="home.php">Online Grocery Shopping</a>
...
<div class="d-flex flex-column flex-md-row align-items-center p-2 px-md-4 bg-white border-bottom box-shadow">
	<h5 class="my-0 mr-md-auto font-weight-normal" style="margin:auto;">Detergents Section</h5>
...
<main>
      ...
      <div class="col-sm-6 col-md-4 col-xl-3 mb-3">
        <a href="gaindescription.php">
          <img class="img-thumbnail mb-3" src="gain.png" alt="Gain Wash Bottle" width="960" height="600">
          <h6 class="mb-1">Gain Wash</h6>
        </a>
      </div>
    
      <div class="col-sm-6 col-md-4 col-xl-3 mb-3">
        <a href="tidedescription.php">
          <img class="img-thumbnail mb-3" src="tide.png" alt="Tide Ultra Bottle" width="960" height="600">
          <h6 class="mb-1">Tide Ultra</h6>
        </a>
      </div>
    
      <div class="col-sm-6 col-md-4 col-xl-3 mb-3">
        <a href="persildescription.php">
          <img class="img-thumbnail mb-3" src="persil.png" alt="Persil Pro-Clean Bottle" width="960" height="600">
          <h6 class="mb-1">Persil Pro-Clean</h6>
        </a>
      </div>

      <div class="col-sm-6 col-md-4 col-xl-3 mb-3">
        <a href="oxydescription.php">
          <img class="img-thumbnail mb-3" src="oxy.png" alt="Oxi-Clean Variety Pack Bottles" width="960" height="600">
          <h6 class="mb-1">Oxi-Clean Variety Pack</h6>
        </a>
      </div>
