...
<main>
	<div class="row justify-content-center">
		<div class="col-sm-6 col-md-6 col-xl-3 mb-3 pr-0">
			...
			<img class="img-thumbnail mb-3 pr-0" src="yogurt.png" alt="Yogurt Tub" width="960" height="600">

		</div>

		<div class="col-sm-6 col-md-6 col-xl-3 mb-3">
			<h5 class="mb-4 pl-2" style="text-align: left;">Astro Original Yogurt</h5>
			<h5 class="mb-5 pl-2" id="price" style="text-align: left;">$5.99</h5>
			...
			<div id="accordion">
				<div class="card">
					...
					<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
						<div class="card-body">
							Astro's 100% natural original balkan yogurt is made with 100% natural ingredients and contains no gelatin. Also made from 100% Canadian dairy.
						</div>
					</div>
				</div>
