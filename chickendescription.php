...
<main>
	<div class="row justify-content-center">
		<div class="col-sm-6 col-md-6 col-xl-3 mb-3 pr-0">
			...
			<img class="img-thumbnail mb-3 pr-0" src="chicken.jpg" alt="Album screenshot" width="960" height="600">
		...
		<div class="col-sm-6 col-md-6 col-xl-3 mb-3">
			<h5 class="mb-4 pl-2" style="text-align: left;">Chicken Breast</h5>
			<h5 class="mb-1 pl-2" id="price" style="text-align: left;">$16.75/kg</h5>
			<h6 class="mb-5 pl-2" style="text-align: left;">$7.60/lb</h6>
			...
			<div id="accordion">
				<div class="card">
					...
					<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
						<div class="card-body">
							Our grass fed chicken lived naturally, steriod, and stress free.  
						</div>
					</div>
				</div>
