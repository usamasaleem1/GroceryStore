...
<main>
  <div class="row justify-content-center">
    ...
    <div class="col-sm-6 col-md-6 col-xl-3 mb-3">
      ...
      <h5 class="mb-1 pl-2" id="price" style="text-align: left">$15.00</h5>
      ...
      <div id="accordion">
        ...
        >
        <div class="card-body">
          Have a little taste of Italy with some delicious Castello del
          Poggio Moscato. Contains 5% alcohol. (750ml/Bottle)
        </div>
      </div>
    </div>
  </div>
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while( $row = mysqli_fetch_array($result) ); 
    {
      ...
      <form method="post" action="cart.php?action=add&id=24">
      ...
      <input type="hidden" name="hidden_name" value="Castello Del Poggio Moscato" >
      <input type="hidden" name="hidden_price" value="15.00">
