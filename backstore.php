...
<div class="d-flex flex-column flex-md-row align-items-center p-2 px-md-4 bg-white">
	<button type='submit' width="120px" height="70px"style="background-color:#343A40; border-radius:25x;" name='userlist'><a href='backstoreUserList.php' style='color:white; background-color:#343A40;'>To User List</a></button>
