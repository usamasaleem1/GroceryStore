    ...
    <main>
      <div class="row justify-content-center">
        ...
        <div class="col-sm-6 col-md-6 col-xl-3 mb-3">
          <h5 class="mb-4 pl-2" style="text-align: left">TV Bar™</h5>
          <h5 class="mb-5 pl-2" id="price" style="text-align: left">$1.00</h5>
          ...
          <div id="accordion">
            <div class="card">
              ...
              >
                <div class="card-body">
                  Tropical coconut & crunchy rice puffs in smooth white
                  chocolate.
                </div>
              </div>
            </div>
