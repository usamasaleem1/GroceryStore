	...
	<main>
		<div class="row justify-content-center">
			<div class="col-sm-6 col-md-6 col-xl-3 mb-3 pr-0">
				...
				<img class="img-thumbnail mb-3 pr-0" src="tide.png" alt="Tide Ultra Bottle" width="960" height="600">

			</div>

			<div class="col-sm-6 col-md-6 col-xl-3 mb-3">
				<h5 class="mb-4 pl-2" style="text-align: left;">Tide Ultra</h5>
				<h5 class="mb-5 pl-2" id="price" style="text-align: left;">$9.25</h5>
				...
				<div id="accordion">
					<div class="card">
						...
						<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
							<div class="card-body">
								Tide Ultra Stain Release digs deep into the stains and removes all traces and leaves your clothes cleaner than when you bought them.
							</div>
						</div>
					</div>
				...
				if (mysqli_num_rows($result) > 0) {
					...
					while( $row = mysqli_fetch_array($result) ); 
					{
						...
						<form method="post" action="cart.php?action=add&id=14">
							<form>
								...
								<input type="hidden" name="hidden_name" value="Tide Ultra" >
								<input type="hidden" name="hidden_price" value="9.25">
