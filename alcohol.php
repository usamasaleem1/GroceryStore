...
<div class="d-flex flex-column flex-md-row align-items-center p-2 px-md-4 bg-white border-bottom box-shadow">
	<h5 class="my-0 mr-md-auto font-weight-normal" style="margin:auto;">Alcohol Section</h5>
...
<main>
	<div class="row">
		<div class="col-sm-6 col-md-4 col-xl-3 mb-3">
			<a href="seltzerdescription.php">
				<img class="img-thumbnail mb-3" src="seltzer.png" alt="Seltzer Can" width="960" height="600">
				<h6 class="mb-1">Happy Dad Hard Seltzer</h6>
			</a>
		</div>
    
		<div class="col-sm-6 col-md-4 col-xl-3 mb-3">
			<a href="heinekendescription.php">
				<img class="img-thumbnail mb-3" src="beer.png" alt="Heineken Beer Bottle" width="960" height="600">
				<h6 class="mb-1">Heineken Beer</h6>
			</a>
		</div>
    
		<div class="col-sm-6 col-md-4 col-xl-3 mb-3">
			<a href="winedescription.php">
				<img class="img-thumbnail mb-3" src="wine.png" alt="Red Wine Bottle" width="960" height="600" style="object-fit: contain;">
				<h6 class="mb-1">Barefoot Red Wine</h6>
			</a>
		</div>
    
		<div class="col-sm-6 col-md-4 col-xl-3 mb-3">
			<a href="moscatodescription.php">
				<img class="img-thumbnail mb-3" src="moscato.png" alt="Moscato Bottle" width="960" height="600">
				<h6 class="mb-1">Castello del Poggio Moscato</h6>
			</a>
		</div>
