	...
	<main>
		<div class="row justify-content-center">
			<div class="col-sm-6 col-md-6 col-xl-3 mb-3 pr-0">
				...
				<img class="img-thumbnail mb-3 pr-0" src="persil.png" alt="Persil Pro-Clean Bottle" width="960" height="600">

			</div>

			<div class="col-sm-6 col-md-6 col-xl-3 mb-3">
				<h5 class="mb-4 pl-2" style="text-align: left;">Persil Pro-Clean</h5>
				<h5 class="mb-5 pl-2" id="price" style="text-align: left;">$6.40</h5>
				...
				<div id="accordion">
					<div class="card">
						...
						<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
							<div class="card-body">
								Persil Pro-Clean is an excellent stain fighter that does a thorough deep clean, as well as has boosted stain removal capabilities.
							</div>
						</div>
					</div>
				...
				if (mysqli_num_rows($result) > 0) {
					...
					while( $row = mysqli_fetch_array($result) ); 
					{
						...
						<form method="post" action="cart.php?action=add&id=15">
							...
							<input type="hidden" name="hidden_name" value="Persil Pro-Clean" >
							<input type="hidden" name="hidden_price" value="6.40">
