...
<main>
	<div class="row justify-content-center">
		<div class="col-sm-6 col-md-6 col-xl-3 mb-3 pr-0">
			...
			<img class="img-thumbnail mb-3 pr-0" src="snickers.jpg" alt="Snickers Bar" width="960" height="600">
		...
		<div class="col-sm-6 col-md-6 col-xl-3 mb-3">
			<h5 class="mb-4 pl-2" style="text-align: left;">Snickers™ Bar</h5>
			<h5 class="mb-5 pl-2" id="price" style="text-align: left;">$1.50</h5>
			...
			<div id="accordion">
				<div class="card">
					...
					<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
						<div class="card-body">
							When you’re looking for a treat that really satisfies, look no further than Snickers. Packed with peanuts, nougat, caramel and milk chocolate, it's delicious! Whether simply unwrapped and enjoyed or incorporated into your favourite dessert recipes, Snickers handles your hunger so that you can handle, well... anything.
						</div>
					</div>
				</div>
