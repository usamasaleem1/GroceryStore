...
<div class="boxed">
	<div class="middle">
	<h1 class="topspacing">Forgot Your Password?</h1>
		<div class="row">
			<div class="col-sm-6 col-md-6 col-xl-6">
				<div class="right">
					<h6 class="topspacing" style="text-align:left;">Enter your email and if you have an account associated with that email, you will receive instructions to
					reset your password.<br>Make sure to check your spam folders.</h6>
					<form>
						<input class="spacing" type="text" name="email" placeholder="Enter your email" required><br>
						<input class = "spacing" type="submit" value="Submit"><br>
					</form>
			...
			<div class="col-sm-6 col-md-6 col-xl-6">
				<h6 class="topspacing" style="text-align:left;">Did you forget your email address?</h6>
				<a href="contact.php"><p style="text-align:left;">Contact Our Team</p></a>
			</div>
		</div>
	</div>
</div>
