...
<div class="d-flex flex-column flex-md-row align-items-center p-2 px-md-4 bg-white border-bottom box-shadow">
   ...
   <a class="btn btn-outline-primary" href="backstoreUserListEdit.html"> Add <img src="edit.png" width="30px" height="30px"> </a>
   ...
   <a class="btn btn-outline-primary" href="backstoreUserListEdit.html">Edit Items <img src="edit.png" width="30px" height="30px"> </a>
  </div>
