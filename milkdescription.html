...
<head>
	...
	<meta charset="utf-8">
	<title>2% Partly Skimmed Milk</title>
...
<main>
	<div class="row justify-content-center">
		<div class="col-sm-6 col-md-6 col-xl-3 mb-3 pr-0">
			...
			<img class="img-thumbnail mb-3 pr-0" src="milk.png" alt="Milk Carton" width="960" height="600">
		...
		<div class="col-sm-6 col-md-6 col-xl-3 mb-3">
			<h5 class="mb-4 pl-2" style="text-align: left;">2% Partly Skimmed Milk 2L</h5>
			<h5 class="mb-5 pl-2" id="price" style="text-align: left;">$4.40</h5>
			...
			<div id="accordion">
				<div class="card">
					...
					<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
						<div class="card-body">
							Rich in nutrients, milk has been a food staple for centuries. Farquhars is a trusted milk distributor and provides the highest quality.
						</div>
					</div>
				</div>
